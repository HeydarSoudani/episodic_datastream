...
def get_data(dataset):
  ...
  data = [
    {
      ...
      'mean': np.array([
        [80.18, 84.84, 86.95, 87.58], #our-dce:    [80.186±0.813, 84.846±0.242, 86.953±0.079, 87.580±0.447],
  ...
  if dataset == 'Fashion_MNIST':
    data = [
      [80.18, 84.84, 86.95, 87.58], #our-dce:    
      [81.07, 84.53, 86.24, 87.07], #our-ce:     
      [75.91, 79.14, 81.83, 83.78], #cope:       
      [49.21, 51.61, 50.38, 50.93], #icarl:      
      [72.61, 79.72, 83.62, 83.24], #reservoir:  
      [47.38, 67.96, 77.64, 82.46], #gss:        [47.384±4.438, 67.968±3.487, 77.647±4.181, 82.460±1.854]
      [39.69, 35.46, 32.65, 44.20], #gem:        [39.693±14.88, 35.463±0.638, 32.650±13.95, 44.207±9.255]
