...
def get_pfmnist_data():
  data = [
    {
      'label': 'Meta-CE (cls)',
      'acc_avg': '73.6±14.5',
      'acc': np.array([0.148, 0.702, 0.728, 0.712, 0.722, 0.74, 0.715, 0.77, 0.782, 0.732, 0.759, 0.77, 0.086, 0.676, 0.721, 0.752, 0.742, 0.769, 0.776, 0.759, 0.762, 0.798, 0.807, 0.76, 0.81, 0.765, 0.799, 0.796, 0.835, 0.797, 0.814, 0.826, 0.822, 0.837, 0.787, 0.805, 0.799, 0.782, 0.798, 0.813, 0.79, 0.831, 0.845, 0.812, 0.82, 0.804, 0.793, 0.846, 0.822, 0.772, 0.152, 0.699, 0.726, 0.734, 0.725, 0.723, 0.742, 0.753, 0.774, 0.308, 0.711, 0.702, 0.725, 0.736, 0.731, 0.75, 0.782, 0.785, 0.785, 0.764])
    },
    {
      'label': 'Meta-CE (dist)',
      'acc_avg': '68.4±14.2',
      'acc': np.array([0.101, 0.716, 0.705, 0.741, 0.703, 0.708, 0.704, 0.735, 0.719, 0.712, 0.718, 0.73, 0.091, 0.67, 0.709, 0.722, 0.698, 0.708, 0.739, 0.76, 0.721, 0.72, 0.743, 0.712, 0.742, 0.718, 0.745, 0.718, 0.774, 0.763, 0.724, 0.775, 0.749, 0.757, 0.75, 0.728, 0.745, 0.741, 0.764, 0.733, 0.738, 0.749, 0.708, 0.723, 0.757, 0.725, 0.757, 0.751, 0.744, 0.716, 0.117, 0.624, 0.688, 0.667, 0.717, 0.678, 0.719, 0.661, 0.73, 0.173, 0.64, 0.659, 0.66, 0.692, 0.684, 0.704, 0.71, 0.681, 0.707, 0.707])
    },
    {
      'label': 'MT-triplet (cls)',
      'acc_avg': '64.1±15.9',
      'acc': np.array([0.121, 0.244, 0.441, 0.578, 0.607, 0.644, 0.611, 0.7, 0.693, 0.673, 0.697, 0.714, 0.17, 0.292, 0.522, 0.588, 0.623, 0.677, 0.692, 0.697, 0.715, 0.687, 0.72, 0.73, 0.72, 0.72, 0.722, 0.732, 0.758, 0.761, 0.756, 0.766, 0.77, 0.761, 0.763, 0.756, 0.749, 0.762, 0.768, 0.767, 0.785, 0.793, 0.788, 0.743, 0.77, 0.745, 0.764, 0.781, 0.772, 0.76, 0.176, 0.312, 0.455, 0.578, 0.591, 0.615, 0.645, 0.646, 0.63, 0.347, 0.47, 0.537, 0.593, 0.635, 0.621, 0.656, 0.686, 0.693, 0.705, 0.705])
    },
    {
      'label': 'MT-triplet (dist)',
      'acc_avg': '66.5±13.1',
      'acc': np.array([0.101, 0.631, 0.65, 0.64, 0.647, 0.663, 0.659, 0.71, 0.69, 0.692, 0.712, 0.719, 0.176, 0.613, 0.708, 0.71, 0.684, 0.69, 0.702, 0.701, 0.699, 0.706, 0.753, 0.7, 0.708, 0.719, 0.731, 0.705, 0.725, 0.738, 0.736, 0.724, 0.74, 0.734, 0.733, 0.731, 0.727, 0.706, 0.723, 0.726, 0.738, 0.75, 0.727, 0.715, 0.741, 0.704, 0.722, 0.752, 0.738, 0.713, 0.144, 0.62, 0.638, 0.69, 0.671, 0.675, 0.717, 0.688, 0.684, 0.197, 0.648, 0.652, 0.633, 0.639, 0.647, 0.68, 0.667, 0.661, 0.682, 0.679])
    },
    {
      'label': 'devdan-dyn',
      'acc_avg': '54.2±12.1',
      'acc': np.array([0.084, 0.525, 0.592, 0.531, 0.476, 0.57, 0.555, 0.474, 0.472, 0.567, 0.605, 0.695, 0.157, 0.394, 0.418, 0.536, 0.608, 0.602, 0.515, 0.664, 0.598, 0.629, 0.625, 0.521, 0.694, 0.564, 0.653, 0.575, 0.611, 0.605, 0.656, 0.528, 0.591, 0.65, 0.642, 0.628, 0.617, 0.654, 0.649, 0.665, 0.669, 0.549, 0.546, 0.61, 0.572, 0.66, 0.615, 0.595, 0.61, 0.642, 0.18, 0.33, 0.504, 0.369, 0.479, 0.55, 0.526, 0.477, 0.515, 0.259, 0.532, 0.5, 0.369, 0.479, 0.485, 0.604, 0.561, 0.538, 0.583, 0.62])
    },
  ]
  return data
...
def main():
  n_chunk = 70
  colors = ['limegreen', 'dodgerblue', 'deeppink', 'darkorange', 'maroon',  'blueviolet', 'royalblue', 'darkorange', 'gold', 'brown']
  # data = get_pmnist_devdan_data()
  # data = get_pmnist_data()
  # data = get_rmnist_data()
  # data = get_rfmnist_data()
  data = get_pfmnist_data()
  ...
  # ['Permuted-MNIST DEVDAN', 'Permuted-MNIST', 'Rotated-MNIST', 'Rotated-FashionMNIST', 'Permuted-FashionMNIST']
  plt.title('Permuted-FashionMNIST', fontsize=14)
  plt.ylim([0, 1])
  plt.xlim([0, n_chunk])
