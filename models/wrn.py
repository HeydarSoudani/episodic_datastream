...
class WideResNet(nn.Module):
    ...
    def to(self, *args, **kwargs):
        ...
        self.block1 = self.block1.to(*args, **kwargs)
        self.block2 = self.block2.to(*args, **kwargs)
        self.block3 = self.block3.to(*args, **kwargs)
        self.bn1 = self.bn1.to(*args, **kwargs)
        self.relu = self.relu.to(*args, **kwargs)
        self.fc = self.fc.to(*args, **kwargs)
        # self.nChannels = self.nChannels.to(*args, **kwargs)
        return self
